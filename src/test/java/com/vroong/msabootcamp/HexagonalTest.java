...
public class HexagonalTest {
  ...
  static final JavaClasses importedClasses = new ClassFileImporter()
      ...
      .importPackages("com.vroong.msabootcamp");

  @Test
  public void domainShouldNotDependOnAnyOtherPackages() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.msabootcamp.domain..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.msabootcamp.application..", "com.vroong.msabootcamp.adapter..")
  ...
  public void applicationShouldNotDependOnAdapter() {
    noClasses()
        .that()
        .resideInAnyPackage("com.vroong.msabootcamp.application..")
        .should()
        .dependOnClassesThat()
        .resideInAnyPackage("com.vroong.msabootcamp.adapter..")
